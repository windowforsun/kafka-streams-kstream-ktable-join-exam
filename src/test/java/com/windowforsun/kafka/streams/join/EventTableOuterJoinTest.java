...
@ActiveProfiles("test")
public class EventTableOuterJoinTest {
	...
	public void setUp() {
		...
		EventTableOuterJoin eventTableOuterJoin = new EventTableOuterJoin(10000L,
			0L,
			"click-topic",
			"view-topic",
			"result-topic");
		eventTableOuterJoin.process(this.streamsBuilder);
