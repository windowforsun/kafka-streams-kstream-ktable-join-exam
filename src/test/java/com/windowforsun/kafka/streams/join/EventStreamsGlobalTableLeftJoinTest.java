...
@ActiveProfiles("test")
public class EventStreamsGlobalTableLeftJoinTest {
	...
	public void setUp() {
		...
		EventStreamsGlobalTableLeftJoin eventStreamsGlobalTableLeftJoin = new EventStreamsGlobalTableLeftJoin(10000L,
			0L,
			"click-topic",
			"view-topic",
			"result-topic");
		eventStreamsGlobalTableLeftJoin.process(this.streamsBuilder);
