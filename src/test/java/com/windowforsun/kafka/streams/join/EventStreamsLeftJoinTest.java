...
@ActiveProfiles("test")
public class EventStreamsLeftJoinTest {
	...
	public void setUp() {
		...
		EventStreamsLeftJoin eventStreamsLeftJoin = new EventStreamsLeftJoin(10000L,
			0L,
			"click-topic",
			"view-topic",
			"result-topic");
		eventStreamsLeftJoin.process(this.streamsBuilder);
