...
@ActiveProfiles("test")
public class EventStreamsGlobalTableJoinTest {
	...
	public void setUp() {
		...
		EventStreamsGlobalTableJoin eventStreamsGlobalTableJoin = new EventStreamsGlobalTableJoin(10000L,
			0L,
			"click-topic",
			"view-topic",
			"result-topic");
		eventStreamsGlobalTableJoin.process(this.streamsBuilder);
